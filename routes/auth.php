...
Route::middleware('guest')->group(function () {
    ...
    //////////// admin route ///////////////////////////
    Route::get('admin/register', [AdminController::class, 'add'])->name('admin.view');
    ...
    Route::get('trainer/register', [TrainerController::class, 'add'])->name('trainer.view');

    Route::post('trainer/register', [TrainerController::class, 'register'])->name('trainer.register');

    Route::post('login/trainer', [TrainerController::class, 'store'])->name('trainer.login');
...
Route::post('trainer/logout', [TrainerController::class, 'destroy'])->middleware('auth:trainer')->name('trainert.logout');
